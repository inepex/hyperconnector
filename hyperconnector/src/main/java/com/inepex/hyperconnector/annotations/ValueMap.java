...
/**
 * <p>Indicates that the annotated field is a value map. Currently only primitive types 
 * are supported both in the key and in the value field of the map. However, serialized
 * values of complex data objects may be stored in the map as String objects.</p>
 * 
